package com.ofeq.AplikasiRetrovolley;
...
import com.ofeq.AplikasiRetrovolley.retrofit.MethodHTTP;
...
public class AddUserActivity extends AppCompatActivity {
    ...
    public void submitByRetrofit(User user){
        ...
        proDialog.show();
        Retrofit.Builder builder= new Retrofit.Builder().baseUrl("http://192.168.1.8/VOLLEY/").addConverterFactory(GsonConverterFactory.create());
    ...
    public void submitByVolley(User user){
        Gson gson = new Gson();
        String URL = "http://192.168.1.8/VOLLEY/User_Registration.php";
        ProgressDialog proDialog = new ProgressDialog(this);
